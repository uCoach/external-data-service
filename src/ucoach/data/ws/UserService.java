 ...
 * 
 */
@WebServiceClient(name = "UserService", targetNamespace = "http://ws.data.ucoach/", wsdlLocation = "http://192.168.1.121:6900/ws/user?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://192.168.1.121:6900/ws/user?wsdl");
